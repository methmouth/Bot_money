...
class VisionEngine:
    def __init__(self, config, url_stream=None):
        ...
        if self.url_stream:
            print(f"[*] Conectando a stream WiFi: {self.url_stream}")
    ...
    def get_frame(self):
        ...
        # Captura original de ventana scrcpy
        try:
    ...
    def detect_and_track(self, frame):
        # Ajuste de confianza dinámico: más estricto en WiFi por el ruido
        conf_min = 0.55 if self.url_stream else self.config.get('umbral_confianza', 0.4)
